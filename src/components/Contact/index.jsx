...
const redes = [{
  red: 'Instagram',
  link: 'https://www.instagram.com/jhontattoo/',
  icon: <IoLogoInstagram />
}, {
  red: 'Linkedin',
  link: 'https://www.linkedin.com/in/jhon-correa/',
  icon: <AiFillLinkedin />
}, {
  red: 'Git Hub',
  link: 'https://github.com/jhoncorre',
  icon: <AiFillGithub />
}]
...
const methodContact = [
  {
    method: 'email',
    href: 'mailto:jhondcorrearuiz@gmail.com',
    title: 'jhondcorrearuiz@gmail.com'
  }, {
    method: 'telefono',
    href: 'tel:+573117306459',
    title: '+573117306459'
  }
]
